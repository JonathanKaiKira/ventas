...
class Inventario(tk.Frame):
    ...
    def widgets(self):
        ...
        lblprecio = Label(labelframe, text="Costo",font="sans 14 bold", bg="#C6D9E3")
        ...
        btn_actualizar = Button(frame2, text="Actualizar Inventario", font="sans 16 bold", command=self.actualizar_inventario)
    ...
    def mostrar(self):
        ...
        for elem in result:
            try:
                precio_clp = "{:,.0f} CLP".format(float(elem[3])) if elem[3] else ""
                costo_cop = "{:,.0f} CLP".format(float(elem[4])) if elem[4] else ""
            except ValueError:
                precio_clp = elem[3]
                costo_cop = elem[4]
            self.tre.insert("", 0, text=elem[0], values=(elem[0], elem[1], elem[2], precio_clp, costo_cop, elem[5]))
    ...
    def actualizar_inventario(self):
        ...
        self.mostrar()
        messagebox.showinfo("Actualizar", "El inventario a sido actualizado correctamente.")
    ...
    def editar_producto(self):
        ...
        lbl_precio.grid(row=0, column=0, padx=10, pady=10)
